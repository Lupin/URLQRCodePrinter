 ...
 * horizontal et vertical. `columns` et `rows` sont déclarés pour être
 * **confrontés à la géométrie** par les tests : un préréglage qui ne place pas
 * le nombre d'étiquettes annoncé est un préréglage faux.
 *
